                ...
                <div class="form-group">
                    <div class="form-wrapper" style="width: 50%; margin-right: 25px;">
                        <select id="course" name="course" required class="form-control">
                            ...
                            <option value="HM" <?php echo isset($_POST['course']) && $_POST['course'] == 'HM' ? 'selected' : ''; ?>>HM</option>
                            <option value="CRIM" <?php echo isset($_POST['course']) && $_POST['course'] == 'CRIM' ? 'CRIM' : ''; ?>>CRIM</option>
                            <option value="CPA" <?php echo isset($_POST['course']) && $_POST['course'] == 'CPA' ? 'CPA' : ''; ?>>CPA</option>
                        </select>
